    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div style="font-size:20px;color:blue;font-style:italic">دفترچه خاطرات آنلاین </div> 
                   <div style="font-size:12px;color:blue;font-style:italic"> پروژه پایانی درس طراحی وب دانشکده شریعتی</div>
                   </div>
